...
describe UserTypesController do
  ...
  describe "GET show" do
    it "assigns the requested user_type as @user_type" do
      user_type = UserType.create! valid_attributes
      get :show, {:id => user_type.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested user_type as @user_type" do
      user_type = UserType.create! valid_attributes
      get :edit, {:id => user_type.to_param}, valid_session
      assigns(:user_type).should eq(user_type)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new UserType" do
        expect {
          post :create, {:user_type => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_type as @user_type" do
        ...
        post :create, {:user_type => { "Code" => "invalid value" }}, valid_session
        assigns(:user_type).should be_a_new(UserType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_type" do
        ...
        UserType.any_instance.should_receive(:update).with({ "Code" => "MyString" })
        put :update, {:id => user_type.to_param, :user_type => { "Code" => "MyString" }}, valid_session
      end

      it "assigns the requested user_type as @user_type" do
        user_type = UserType.create! valid_attributes
        put :update, {:id => user_type.to_param, :user_type => valid_attributes}, valid_session
        assigns(:user_type).should eq(user_type)
      end
    ...
    describe "with invalid params" do
      it "assigns the user_type as @user_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserType.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_type.to_param, :user_type => { "Code" => "invalid value" }}, valid_session
        assigns(:user_type).should eq(user_type)
      end
