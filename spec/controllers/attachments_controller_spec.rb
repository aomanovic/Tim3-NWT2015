  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attachment as @attachment" do
        ...
        post :create, {:attachment => { "EvidentionID" => "invalid value" }}, valid_session
        assigns(:attachment).should be_a_new(Attachment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attachment" do
        ...
        Attachment.any_instance.should_receive(:update).with({ "EvidentionID" => "1" })
        put :update, {:id => attachment.to_param, :attachment => { "EvidentionID" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attachment as @attachment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attachment.any_instance.stub(:save).and_return(false)
        put :update, {:id => attachment.to_param, :attachment => { "EvidentionID" => "invalid value" }}, valid_session
        assigns(:attachment).should eq(attachment)
      end
